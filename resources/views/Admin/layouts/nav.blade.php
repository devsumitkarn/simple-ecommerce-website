        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item dropdown-language dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item {{ session('locale') == 'en' ? 'active' : '' }}" href="{{ url('/switch-language/en') }}" aria-label="Switch to English">
                            <span>English</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item {{ session('locale') == 'hi' ? 'active' : '' }}" href="{{ url('/switch-language/hi') }}" aria-label="Switch to Hindi">
                            <span>Hindi</span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);"
                    ...
                    <div class="avatar avatar-online">
                        <img src="{{url('vuexy/assets/img/avatars/1.png')}}" alt class="rounded-circle" />
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
